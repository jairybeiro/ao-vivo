...
const Login = () => {
  ...
  const getLoginErrorMessage = (message: string) => {
    ...
    if (lower.includes("failed to fetch") || lower.includes("network")) return "Falha temporária de conexão. Tente novamente";
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4" style={{ paddingTop: `calc(env(safe-area-inset-top, 0px) + 16px)` }}>
      <div className="w-full max-w-md">
        <Card className="border-primary/20">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl">StreamPlayer</CardTitle>
            <CardDescription>
