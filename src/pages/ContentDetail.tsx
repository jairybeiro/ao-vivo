      ...
      {showTrailerPlayer && hasTrailer && (
        <div className="fixed inset-0 z-[60] bg-black flex flex-col">
          ...
          <button
            ...
            className="absolute bottom-[calc(env(safe-area-inset-bottom)+22px)] right-14 z-[70] flex items-center gap-1 bg-white/80 text-black font-semibold px-2.5 py-1 rounded hover:bg-white transition-colors text-[11px] shadow-md backdrop-blur-sm"
          >
