...
const ChannelList = ({ channels, selectedChannel, onSelectChannel, loading }: ChannelListProps) => {
  ...
  return (
    <div className="bg-sidebar rounded-lg border border-sidebar-border overflow-hidden flex flex-col">
      {/* Header */}
      ...
      {/* Channel List - Scrollable box showing ~3 items */}
      <div className="p-2">
        <div className="max-h-[180px] overflow-y-auto space-y-1 border border-sidebar-border rounded-lg p-1">
          {channels.length === 0 ? (
